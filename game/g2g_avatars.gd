...
## first are kept at the FRONT of each list on purpose: `BODIES[0]` and `HEADS[0]` are
## the schema's defaults, so a deployment that strips the art directory still has a
## default part that exists, and an avatar document written before the art arrived
## still resolves. A capsule is a worse character and a better fallback.
const BODIES: Array[StringName] = [&"body_stock", &"body_slim",
	&"body_kenney_a", &"body_kenney_b", &"body_kenney_c", &"body_kenney_d", &"body_kenney_e", &"body_kenney_f", &"body_kenney_g", &"body_kenney_h", &"body_kenney_i", &"body_kenney_j", &"body_kenney_k", &"body_kenney_l", &"body_kenney_m", &"body_kenney_n", &"body_kenney_o", &"body_kenney_p", &"body_kenney_q", &"body_kenney_r"]
const HEADS: Array[StringName] = [&"head_stock", &"head_box",
	&"head_kenney_a", &"head_kenney_b", &"head_kenney_c", &"head_kenney_d", &"head_kenney_e", &"head_kenney_f", &"head_kenney_g", &"head_kenney_h", &"head_kenney_i", &"head_kenney_j", &"head_kenney_k", &"head_kenney_l", &"head_kenney_m", &"head_kenney_n", &"head_kenney_o", &"head_kenney_p", &"head_kenney_q", &"head_kenney_r"]
