...
Five of the eight maps beside this directory label their own zones: `zone_start`, `map_end_zone`, `startzone_s4`, `tm_bonus2_endzone`. Those are read straight out of the entity lump and need nothing here. This directory is for the other three, and for the halves the labelled ones are missing — and every entry says **why**, because a finish line is a judgement about a map somebody played, and the next person to look at it deserves the evidence rather than a number.
